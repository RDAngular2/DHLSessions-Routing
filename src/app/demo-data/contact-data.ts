...
export class ContactData implements InMemoryDbService {
    ...
    static firstNames = ["Sophie", "Joe", "Josh", "Olivia", "Abdil", "Darren", "Hanz",
        "Amelia", "Jessica", "Alan", "Ava", "Charlotte", "Mia", "Lucy", "Grace", "Ruby",
        "Ella", "Evie", "Freya", "Isla", "Poppy", "Daisy", "Layla"];
    static lastNames = ["Beckham", "Braxton", "Cole", "Brennan", "El Arbi", "Bryson", "Cadwell",
        "Cage", "Carson", "Chandler", "Cohen", "Black", "Corbin", "Dallas", "Dalton", "Dane",
    ...
    public createDb() : any {
        return {
            contacts : ContactData.createContacts(10)
        };
    }
    ...
    constructor() {
        this.contacts = ContactData.createContacts(10);
    }
    ...
    public static createContacts(size:number) {
        ...
        contact = new Contact("Donald","Trump",1);
        contact.birthYear = 1946;
        contact.country = "United States";
        contact.phone = "(+1) 212-666-00-666"
        contact.proficiency = 0.1;
        contact.skills = {"twitter":true};
        contact.email = "donald.trump@trump.com"
        contacts.push(contact);



        for (var i = 0; i < size; i++) {
            contact = new Contact(null,null,i+2);
            ...
            contact.email = `${contact.firstName}.${contact.lastName}@gmail.com`.replace(' ','_');
            contact.skills = {
            ...
            contact.birthYear = 1960 + Math.round(Math.random() * 40);
            contacts.push(contact);
        }
